...
[Collection("Tests")]
public partial class GetMaterialsQueryTests : IClassFixture<Testing>
{
    private readonly Testing _testing;
    public GetMaterialsQueryTests(Testing testing)
    {
        _testing = testing;
    }
    ...
    {
        new object[] { CreateRandomMaterial(), CreateRandomMaterial() }
    };
