...
[Collection("Tests")]
public partial class GetEstimatesQueryHandlerTests : IClassFixture<Testing>
{
    private readonly Testing _testing;

    public GetEstimatesQueryHandlerTests(Testing testing)
    {
        _testing = testing;
    }
    ...
    {
        new object[] { CreateRandomEstimate(), CreateRandomEstimate() }
    };
