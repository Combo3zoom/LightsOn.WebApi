...
[Collection("Tests")]
public partial class GetCustomersQueryTests : IClassFixture<Testing>
{
    private readonly Testing _testing;
    public GetCustomersQueryTests(Testing testing)
    {
        _testing = testing;
    }
    
    public static IEnumerable<object[]> s_randomCustomersTestCaseSource = new List<object[]>
    {
        new object[] { CreateRandomCustomer(), CreateRandomCustomer() }
    };
